...
class OPDecoder(torch.nn.Module):
    def __init__(
        self,
        embedding_dim,
        n_heads=8,
        ...
        self.remainder_dist_embedder = torch.nn.Linear(1, self.embedding_dim)
    ...
    def forward(self, last_node, group_ninf_mask, travelled_dist):
        ...
        travelled_dist_exp = travelled_dist.unsqueeze(2).clone()
        travelled_dist_emb = self.remainder_dist_embedder(travelled_dist_exp)
        final_q = final_q + travelled_dist_emb
